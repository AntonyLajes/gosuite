...
class BestSellerAdapter(private val context: Context, private val furnitureList: List<FurnitureModel>, private val onItemClickListener: OnItemClickListener): RecyclerView.Adapter<BestSellerAdapter.MyViewHolder>() {
